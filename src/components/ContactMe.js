...
const ContactMe = () => {
  ...
  return (
    <>
      <h2 className="ml-20 mx-3 underline underline-offset-4 font-mono pt-16">
        {" "}
        For Contact
      </h2>
      ...
      <div className="md:ml-20 md:flex md:flex-row flex-col justify-center text-center md:w-11/12 h-screen w-full ">
        <div className="flex flex-col w-1/2 justify-center text-center h-1/2 md:border-e-2 border-y-0 border-white ">
          <div className="m-10 md:h-16 h-10 bg-neutral-600 p-2 md:p-4 w-max md:m-auto rounded shadow-lg">
            <p>
              <Icon name="phone" />
              +91 8419966563
            </p>
          </div>
          <div className="m-10 h-16 bg-neutral-600 w-max md:m-auto p-4 rounded shadow-lg">
            <p>
              <Icon name="mail" />
              siddharthshinde2002@gmail.com
            </p>
          </div>
          <div className="m-10 h-16 bg-neutral-600 md:m-auto w-max p-4 rounded shadow-lg">
            <p>
        ...
        <div className=" w-1/2 text-center p-6 h-2/3 ">
          <form className="md:space-y-10" onSubmit={onSubmit}>
            ...
            <div className="space-x-6 ">
              <Button
                className="md:w-1/4 w-32 shadow-lg rounded-xl"
                inverted
                color="teal"
                type="submit"
              >
